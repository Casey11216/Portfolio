...
export default function MetaData({
  ...
  return (
    <Head>
      ...
      <meta property="og:site_name" content="Casey portfolio" />
      ...
      <!-- Twitter card tags -->
      */}
      <meta name="twitter:creator" content="Casey"></meta>
      ...
      <meta
        ...
        content="Picture of Casey, the developer behind the portfolio"
      />
